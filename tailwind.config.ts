...
const config: Config = {
    ...
    theme: {
        extend: {
            ...
            animation: {
                slideLeftAndFade: 'slideLeftAndFade 850ms cubic-bezier(0.16, 1, 0.3, 1)',
                slideRightAndFade: 'slideRightAndFade 850ms cubic-bezier(0.16, 1, 0.3, 1)',
                dropdownMenu: 'dropdownMenu 500ms cubic-bezier(0.16, 1, 0.3, 1)',
